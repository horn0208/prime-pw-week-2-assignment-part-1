...
console.log('My name is ' + fullName + ', and I think '+ 24 +' is a winner!');
...
}//could also just say else { } for this last one, since that condition the only remaining possibility of the 3
